...
import { getDatabase, ref, push, set, update, runTransaction, onValue, remove } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-database.js";
...
export { db, ref, push, set, update, runTransaction, onValue, remove };
