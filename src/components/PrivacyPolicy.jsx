...
export const PrivacyPolicy = ({ lang, isDark }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-20 space-y-8">
      <h1 className={cn("text-4xl font-black", isDark ? "text-white" : "text-slate-900")}>{t.privacyPolicy}</h1>
      <div className={cn(
        ...
        <h2 className={cn("text-2xl font-bold", isDark ? "text-white" : "text-slate-900")}>2. Use of Information</h2>
        <p>We only retain collected information for as long as necessary to provide you with your requested service. What data we store, we’ll protect within commercially acceptable means to prevent loss and theft, as well as unauthorized access, disclosure, copying, use or modification.</p>
        <h2 className={cn("text-2xl font-bold", isDark ? "text-white" : "text-slate-900")}>3. Cookies</h2>
        ...
        <h2 className={cn("text-2xl font-bold", isDark ? "text-white" : "text-slate-900")}>4. Third-party Services</h2>
